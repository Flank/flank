...
public final class AndroidModel extends GenericJson {
  @Key private String brand;
  @Key private String codename;
  @Key private String form;
  @Key private String id;
  @Key private String manufacturer;
  @Key private String name;
  @Key private Integer screenX;
  @Key private Integer screenY;
  @Key private List<String> supportedVersionIds;
