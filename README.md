...
Either [download Flank from here](https://bintray.com/flank1/Flank/download_file?file_path=Flank-1.4.2.jar)
...
```console
curl --location --fail https://dl.bintray.com/flank1/Flank/Flank-1.4.2.jar --output Flank-1.4.2.jar
```
