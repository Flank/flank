...
Either [download Flank from here](https://bintray.com/flank1/Flank/download_file?file_path=Flank-1.4.1.jar)
...
```console
curl --location --fail https://dl.bintray.com/flank1/Flank/Flank-1.4.1.jar --output Flank-1.4.1.jar
```
...
```
java -jar Flank-1.4.1.jar <app-apk> <test-apk> [package-name]
```
