...
import com.google.api.services.testing.model.LinuxMachineCatalog;
import com.google.api.services.testing.model.WindowsMachineCatalog;

public final class Browser
extends GenericJson {
    @Key
    private AndroidDeviceCatalog androidCatalog;
    @Key
    private String id;
    @Key
    private LinuxMachineCatalog linuxCatalog;
    @Key
    private String name;
    @Key
    ...
    @Key
    private WindowsMachineCatalog windowsCatalog;
