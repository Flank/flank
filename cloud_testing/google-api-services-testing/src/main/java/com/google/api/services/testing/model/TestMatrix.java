...
public final class TestMatrix extends GenericJson {
  @Key private ClientInfo clientInfo;
  @Key private EnvironmentMatrix environmentMatrix;
  @Key private String projectId;
  @Key private ResultStorage resultStorage;
  @Key private String state;
  @Key private List<TestExecution> testExecutions;
