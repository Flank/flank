...
internal class TableColumnTest {
    ...
    fun `Should calculate properly column width`() {
        ...
        // when
        val tableColumn = TableColumn("55555", listOf("1", "22", "333", "4444", "55555", "666666"), align = Align.LEFT)
    ...
    fun `Should calculate properly column width when header value is the longest`() {
        ...
        // when
        val tableColumn = TableColumn("55555", listOf("1", "22", "333", "4444"), align = Align.LEFT)
