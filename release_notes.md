## v20.08.2
- [919](https://github.com/Flank/flank/pull/919) **Fix**: rate limit exceeded ([pawelpasterz](https://github.com/pawelpasterz), [jan-gogo](https://github.com/jan-gogo))
- [1015](https://github.com/Flank/flank/pull/1015) **CI changes**: Update mergify configuration ([piotradamczyk5](https://github.com/piotradamczyk5))
- [1013](https://github.com/Flank/flank/pull/1013) **New feature**: Generating docs before release ([piotradamczyk5](https://github.com/piotradamczyk5))
- [1011](https://github.com/Flank/flank/pull/1011) **CI changes**: Generate release notes for Github release description ([piotradamczyk5](https://github.com/piotradamczyk5))
- [1012](https://github.com/Flank/flank/pull/1012) **New feature**: Add ip-blocks command to test-environment command ([pawelpasterz](https://github.com/pawelpasterz))
