...
public final class ResultStorage extends GenericJson {
  @Key private GoogleCloudStorage googleCloudStorage;
  @Key private ToolResultsExecution toolResultsExecution;
  @Key private String toolResultsExecutionId;
  @Key private ToolResultsHistory toolResultsHistory;
  @Key private String toolResultsHistoryId;
  @Key private String toolResultsStepId;
