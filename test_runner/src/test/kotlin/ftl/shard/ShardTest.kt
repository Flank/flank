...
class ShardTest {
    ...
    fun mixedNewAndOld() {
        ...
        assertThat(result.sumByDouble { it.time }).isWithin(0.1).of(7.0 + 3 * 16.5 / 7)
        ...
        assertThat(ordered[2].testMethods.size).isEqualTo(2)
        assertThat(ordered[3].testMethods.size).isEqualTo(2)
    }
